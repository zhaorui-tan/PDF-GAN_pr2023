...
tf.app.flags.DEFINE_string('checkpoint_dir',
                           ...
                           # '/data1/phd21_zhaorui_tan/DAE-GAN/eval/Your_path/DAE-GAN/data/inception_v3_google-1a9a5a14.pth',
                           """Path where to read model checkpoints.""")

tf.app.flags.DEFINE_string('image_folder', '/data1/phd21_zhaorui_tan/DAE-GAN/model/ncl/netG_epoch_600',
