...
if __name__ == '__main__':
    ...
    # if args.data == 'bird':
    #     path = '/data1/phd21_zhaorui_tan/DAE-GAN/model/ncl/netG_epoch_600/valid/single'
    # else:
    #     path = '../models/netG_coco/valid/single/'
    print("Calculating Inception Score...")
    mu, std = inception_score(args.path, cuda=True, batch_size=32, resize=True, splits=10)
